...
2.  Author Information
    Corresponding Investigator Name: Tiago R. Simoes
    Institution: Princeton University, Princeton-NJ, USA
    Email: simoes@princeton.edu

    Co-investigator 1 Name: Arthur Brum
    Institution: Universidade do Estado do Rio de Janeiro, Rio de Janeiro-RJ, Brazil

    Co-investigator 2 Name: Stephanie Pierce
...
| Subfamily | Subfamily-level classification. **Empty cells (147 cells):** subfamily assignment is not applicable or has not been formally designated for these taxa |
...
| specimen_voucher | Museum voucher specimen number associated with the sequence. **Empty cells (266 cells):** specimen voucher information was not available in GenBank for these sequences |
...
| Family | Family-level classification |
| Specimen | Museum specimen number. **Empty cells (3 cells):** specimen numbers not available for Dinilysia_patagonica, Gobekko_cretacicus, and Priscagama_gobiensis |
...
- **Columns:** 3 effective data columns (A, B, C); remaining columns are empty
...
**Description:** Fossil calibration ages used for divergence time estimation. Provides stratigraphic and chronostratigraphic information for each fossil taxon, with minimum and maximum ages based on the International Stratigraphic Chart (ISC 2021).
...
| Stratigraphic level | Geological formation, stratigraphic unit, and locality information. **Empty cells (1 cell):** stratigraphic level not reported for Palaeopleurosaurus |
| Chronostratigraphy | Chronostratigraphic age assignment (e.g., "Induan-Olenekian, Early Triassic"). **Empty cells (1 cell):** chronostratigraphy not reported for Tetrapodophis |
| MaxAge (ISC 2021) | Maximum age in millions of years ago (Ma) based on ISC 2021 |
| MinAge (ISC 2021) | Minimum age in millions of years ago (Ma) based on ISC 2021 |
...
- **Columns:** 1
- **Empty cells (1 cell):** Row 2 is a blank separator between the header and the abbreviation list.
...
- **Rows:** 67
- **Columns:** 1
- **Empty cells (1 cell):** Row 67 is a trailing blank row at the end of the list.
...
**No empty cells in any sheet of this file.**
...
| max | Maximum normalized rate |
| range | Range of normalized rates |
| tree_size | Taxon sampling identifier (e.g., "106t_(14%_fossils)", "122t_(24%_fossils)", "92t_(0%_fossils)") |
