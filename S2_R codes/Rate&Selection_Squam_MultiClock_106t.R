...
setwd("D:/Programas/Rcodes/PhyloParameters/Squamata_2024/4Mol4Mor_106t_50F")
...
tree_subset <- read.nexus("pruned_tree50.nex")
...
#@S4 class tree
write.beast(pruned_tree, "MCT_106t.tre")
...
tree<-treeio::read.mrbayes("MCT_106t.tre") 
...
ggplot2::ggsave	("MCT_106t_nodes.pdf", width=14, height=20)


#Specify the ancestral nodes and their string names
ancestral_nodes <- list(
  Other_Lepidosauria = c(2,3),
  Gekkota = 111,
  Scincoidea = 128,
  Lacertoidea = "140 - 151",
  Amphisbaenia = 151,
...
Clock4P_106t<-clockrate_dens_plot(RateTable_Means_Clades, clock = 5:8, stack = TRUE, nrow = 4, scales = "fixed")+
  ggplot2::scale_colour_viridis_d(option = "turbo")+
  ggplot2::scale_fill_viridis_d(option = "turbo")+
  ggplot2::scale_x_log10()+
  labs(x = " Relative rate mean")
Clock4P_106t
ggplot2::ggsave	("Clock4P_106t_RatesByClade_Mean_P5-P8.pdf", width=6, height=12)


#Norm rates
## Stacked plots with viridis color scale
## Stacked plots with viridis color scale
Clock4P_106t_N<- clockrate_dens_plot(RateTable_MeansNorm_Clades, clock = 5:8, stack = TRUE, nrow = 4, scales = "fixed")+
  ggplot2::scale_colour_viridis_d(option = "turbo")+
  ggplot2::scale_fill_viridis_d(option = "turbo")+
  labs(x = " Relative rate mean (normalized)")
Clock4P_106t_N
ggplot2::ggsave	("Clock4P_106t_RatesbyClade_MeanNORM_P5-P8.pdf", width=4, height=10)
...
Pl1a <- ggtree(tree, layout = "rectangular", ladderize=TRUE, right=TRUE, size=0.1) +
  ...
  theme_tree() +
  geom_cladelabel(node=111, label="Gekkota", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=128, label="Scincoidea", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=141, label="Teiioidea", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=151, label="Amph.", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=173, label="Anguiformes", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=158, label="Acrodonta", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=161, label="Pleurodonta", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=188, label="Scolec.", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=195, label="'Haenophidia'", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4) +
  geom_cladelabel(node=201, label="Caenophidia", align=TRUE,
                  barsize = 1.5, fontsize = 6, angle = 90, hjust='center',
                  geom = "text", color = "black", fill = NA, offset = 45, offset.text=4)
Pl1a <- revts(Pl1a)
Pl1a
...
plot_clockrate_by_part_circ <- function(partition_number) {
  ...
  plot <- ggtree(tree_norm, layout = "circular", ladderize=TRUE, right=TRUE,
    ...
    geom_cladelabel(node=141, label="Teiioidea", align=TRUE,
                    barsize = 1.5, fontsize = 6, angle = "auto",horizontal = FALSE, hjust='center', offset.text = 6,
                    geom = "text", color = "black", fill = NA) +
    geom_cladelabel(node=151, label="Amphisb.", align=TRUE,
    ...
    geom_cladelabel(node=201, label="Caenophidia", align=TRUE,
                    barsize = 1.5, fontsize = 6, angle = "auto",horizontal = FALSE, hjust='center', offset.text = 6,
                    geom = "text", color = "black", fill = NA) +
    geom_strip(taxa1= 84, taxa2= 91, label="'Haenophidia'", align=TRUE,
